...
resource "aws_lambda_function" "process-workflow-completion" {
  filename         = "./../workflows/ProcessWorkflowCompletion/dist/lambda.zip"
...
resource "aws_lambda_function" "process-workflow-failure" {
  filename         = "./../workflows/ProcessWorkflowFailure/dist/lambda.zip"
...
resource "aws_lambda_function" "workflow-activity-callback-handler" {
  filename         = "./../workflows/WorkflowActivityCallbackHandler/dist/lambda.zip"
