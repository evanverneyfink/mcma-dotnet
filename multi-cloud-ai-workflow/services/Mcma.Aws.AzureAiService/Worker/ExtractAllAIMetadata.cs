...
namespace Mcma.Aws.AzureAiService.Worker
{
    internal class ExtractAllAIMetadata : IJobProfileHandler<AIJob>
    {
        ...
        public async Task RunAsync(WorkerJobHelper<AIJob> jobHelper)
        {
            S3Locator inputFile;
            ...
            var nonSecureHost = new Uri(jobHelper.Request.ContextVariables["PublicUrlNonSecure"], UriKind.Absolute).Host;
